...
function Portfolio() {
 ...
 <section id="contact" className="container py-28"><div className="grid md:grid-cols-12 gap-x-10 gap-y-14"><div className="md:col-span-5"><div className="eyebrow mb-7">Get in touch</div><h2 className="text-[clamp(3rem,6vw,6rem)] leading-[.9] tracking-[-.055em]">Let’s make<br /><i>spatial ideas real.</i></h2><p className="mt-8 max-w-md text-lg leading-7 text-neutral-600">Have a geospatial challenge, an interesting role, or an idea worth exploring? Send me a note. I’m always interested in thoughtful work around maps, cities, Earth observation and spatial data.</p><div className="mt-9 flex flex-wrap gap-3"><a href="mailto:esmat.tariq4747@gmail.com" className="border border-neutral-900 px-4 py-2.5 text-sm hover:bg-neutral-900 hover:text-white transition">Email ↗</a><a href="https://www.linkedin.com/in/esmat-fahim-52844a199" target="_blank" rel="noreferrer" className="border border-neutral-900 px-4 py-2.5 text-sm hover:bg-neutral-900 hover:text-white transition">LinkedIn ↗</a><a href="https://github.com/esmat-fahim/esmat-fahim" target="_blank" rel="noreferrer" className="border border-neutral-900 px-4 py-2.5 text-sm hover:bg-neutral-900 hover:text-white transition">GitHub ↗</a><a href="/cv.pdf" className="border border-neutral-900 px-4 py-2.5 text-sm hover:bg-neutral-900 hover:text-white transition">CV ↓</a></div></div><div className="md:col-span-6 md:col-start-7 md:pt-8"><div className="mb-8"><div className="eyebrow text-neutral-500">Start a conversation</div><p className="mt-3 text-2xl md:text-3xl tracking-tight">Tell me what you’re working on.</p></div><ContactForm /></div></div></section>
